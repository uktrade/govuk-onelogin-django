...
SECRET_KEY = "django-insecure-npu=_%vz$0s(uz@izc^m!g$7ge7u_(%$5nf8y_z&y8o_i+gizi"
...
AUTHENTICATION_BACKENDS = ["govuk_onelogin_django.backends.OneLoginBackend"]
...
GOV_UK_ONE_LOGIN_AUTHENTICATION_LEVEL = env.gov_uk_one_login_authentication_level
GOV_UK_ONE_LOGIN_CONFIDENCE_LEVEL = env.gov_uk_one_login_confidence_level
